...
vm/victoria-metrics-agent  	0.5.2        	v1.41.0    	Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-cluster	0.6.6        	1.41.0     	Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-single 	0.5.22        	1.41.0     	Victoria Metrics Single version - high-performa...
```
