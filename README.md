...
vm/victoria-metrics-agent    0.7.11         v1.57.0     Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-alert    0.3.25         v1.57.0     Victoria Metrics Alert - executes a list of giv...
vm/victoria-metrics-auth     0.2.17         1.57.0      Victoria Metrics Auth - is a simple auth proxy ...
vm/victoria-metrics-cluster  0.8.19         1.57.0      Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-operator 0.1.9          0.11.0       Victoria Metrics Operator
vm/victoria-metrics-single   0.6.20         1.57.0      Victoria Metrics Single version - high-performa...
```
