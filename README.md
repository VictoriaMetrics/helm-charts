...
vm/victoria-metrics-agent    0.6.10          v1.50.2     Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-alert    0.3.10          v1.50.2     Victoria Metrics Alert - executes a list of giv...
vm/victoria-metrics-auth     0.2.6          1.50.2      Victoria Metrics Auth - is a simple auth proxy ...
vm/victoria-metrics-cluster  0.8.7          1.50.2      Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-operator 0.1.3          0.6.1       Victoria Metrics Operator
vm/victoria-metrics-single   0.6.9          1.50.2      Victoria Metrics Single version - high-performa...
```
