...
vm/victoria-metrics-agent  	0.4.10        	v1.39.0    	Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-cluster	0.5.20        	1.39.0     	Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-single 	0.5.15        	1.39.0     	Victoria Metrics Single version - high-performa...
```
