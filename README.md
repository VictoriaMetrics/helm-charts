...
vm/victoria-metrics-agent     0.7.44       	v1.76.0     Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-alert     0.4.25        	v1.76.0     Victoria Metrics Alert - executes a list of giv...
vm/victoria-metrics-auth      0.2.43       	1.76.0      Victoria Metrics Auth - is a simple auth proxy ...
vm/victoria-metrics-cluster   0.9.20        	1.76.0      Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-k8s-stack 0.7.12        	1.76.0      Kubernetes monitoring on VictoriaMetrics stack....
vm/victoria-metrics-operator  0.5.1        	0.21.0      Victoria Metrics Operator
vm/victoria-metrics-single    0.8.22        	1.76.0      Victoria Metrics Single version - high-performa...
```
