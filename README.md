...
vm/victoria-metrics-agent  	0.5.6        	v1.42.0    	Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-cluster	0.6.9        	1.42.0     	Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-single 	0.5.25        	1.42.0     	Victoria Metrics Single version - high-performa...
```
