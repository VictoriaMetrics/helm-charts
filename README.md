...
vm/victoria-metrics-agent     0.7.32       	v1.67.0     Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-alert     0.4.11        	v1.67.0     Victoria Metrics Alert - executes a list of giv...
vm/victoria-metrics-auth      0.2.31       	1.67.0      Victoria Metrics Auth - is a simple auth proxy ...
vm/victoria-metrics-cluster   0.9.8        	1.67.0      Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-k8s-stack 0.5.4        	1.67.0      Kubernetes monitoring on VictoriaMetrics stack....
vm/victoria-metrics-operator  0.3.0        	0.19.0      Victoria Metrics Operator
vm/victoria-metrics-single    0.8.9        	1.67.0      Victoria Metrics Single version - high-performa...
```
