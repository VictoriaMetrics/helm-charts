...
vm/victoria-metrics-agent     0.7.36       	v1.71.0     Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-alert     0.4.16        	v1.71.0     Victoria Metrics Alert - executes a list of giv...
vm/victoria-metrics-auth      0.2.36       	1.71.0      Victoria Metrics Auth - is a simple auth proxy ...
vm/victoria-metrics-cluster   0.9.14        	1.71.0      Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-k8s-stack 0.6.4        	1.71.0      Kubernetes monitoring on VictoriaMetrics stack....
vm/victoria-metrics-operator  0.5.1        	0.21.0      Victoria Metrics Operator
vm/victoria-metrics-single    0.8.14        	1.71.0      Victoria Metrics Single version - high-performa...
```
