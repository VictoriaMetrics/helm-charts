...
vm/victoria-metrics-agent     0.7.40       	v1.73.1     Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-alert     0.4.22        	v1.73.1     Victoria Metrics Alert - executes a list of giv...
vm/victoria-metrics-auth      0.2.40       	1.73.1      Victoria Metrics Auth - is a simple auth proxy ...
vm/victoria-metrics-cluster   0.9.17        	1.73.1      Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-k8s-stack 0.7.6        	1.73.1      Kubernetes monitoring on VictoriaMetrics stack....
vm/victoria-metrics-operator  0.5.1        	0.21.0      Victoria Metrics Operator
vm/victoria-metrics-single    0.8.19        	1.73.1      Victoria Metrics Single version - high-performa...
```
