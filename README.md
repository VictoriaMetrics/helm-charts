...
vm/victoria-metrics-agent     0.8.24       	v1.85.1     Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-alert     0.5.9        	v1.85.1     Victoria Metrics Alert - executes a list of giv...
vm/victoria-metrics-auth      0.2.65       	1.85.1      Victoria Metrics Auth - is a simple auth proxy ...
vm/victoria-metrics-cluster   0.9.45        	1.85.1      Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-gateway   0.1.23        	1.85.1      Victoria Metrics Gateway - is a simple gateway ...
vm/victoria-metrics-k8s-stack 0.13.3        	1.85.1      Kubernetes monitoring on VictoriaMetrics stack....
vm/victoria-metrics-operator  0.12.1        	0.27.1      Victoria Metrics Operator
vm/victoria-metrics-single    0.8.46        	1.85.1      Victoria Metrics Single version - high-performa...
```
