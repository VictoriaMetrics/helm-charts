...
vm/victoria-metrics-agent    	0.8.34       	v1.89.0    	Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-alert    	0.5.20       	v1.89.0    	Victoria Metrics Alert - executes a list of giv...
vm/victoria-metrics-anomaly  	0.3.1        	v1.1.0     	Victoria Metrics Anomaly Detection - a service ...
vm/victoria-metrics-auth     	0.2.75       	1.89.0     	Victoria Metrics Auth - is a simple auth proxy ...
vm/victoria-metrics-cluster  	0.9.58       	1.89.0     	Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-gateway  	0.1.33       	1.89.0     	Victoria Metrics Gateway - Auth & Rate-Limittin...
vm/victoria-metrics-k8s-stack	0.14.13       	1.89.0     	Kubernetes monitoring on VictoriaMetrics stack....
vm/victoria-metrics-operator 	0.18.0       	0.30.4     	Victoria Metrics Operator
vm/victoria-metrics-single   	0.8.56       	1.89.0     	Victoria Metrics Single version - high-performa...
```
