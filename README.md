...
vm/victoria-metrics-auth      0.2.29       	1.66.2      Victoria Metrics Auth - is a simple auth proxy ...
vm/victoria-metrics-cluster   0.9.5        	1.66.2      Victoria Metrics Cluster version - high-perform...
...
vm/victoria-metrics-single    0.8.6        	1.66.2      Victoria Metrics Single version - high-performa...
```
