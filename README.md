...
vm/victoria-metrics-agent     0.8.11       	v1.78.1     Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-alert     0.4.34        	v1.78.1     Victoria Metrics Alert - executes a list of giv...
vm/victoria-metrics-auth      0.2.52       	1.78.1      Victoria Metrics Auth - is a simple auth proxy ...
vm/victoria-metrics-cluster   0.9.31        	1.78.1      Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-gateway   0.1.9        	1.78.1      Victoria Metrics Gateway - is a simple gateway ...
vm/victoria-metrics-k8s-stack 0.9.6        	1.78.1      Kubernetes monitoring on VictoriaMetrics stack....
vm/victoria-metrics-operator  0.9.0        	0.24.0      Victoria Metrics Operator
vm/victoria-metrics-single    0.8.32        	1.78.1      Victoria Metrics Single version - high-performa...
```
