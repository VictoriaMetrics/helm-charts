...
vm/victoria-metrics-agent  	0.5.1        	v1.40.1    	Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-cluster	0.6.5        	1.40.1     	Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-single 	0.5.21        	1.40.1     	Victoria Metrics Single version - high-performa...
```
