...
vm/victoria-metrics-agent     0.8.12       	v1.79.0     Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-alert     0.4.35        	v1.79.0     Victoria Metrics Alert - executes a list of giv...
vm/victoria-metrics-auth      0.2.53       	1.79.0      Victoria Metrics Auth - is a simple auth proxy ...
vm/victoria-metrics-cluster   0.9.32        	1.79.0      Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-gateway   0.1.10        	1.79.0      Victoria Metrics Gateway - is a simple gateway ...
vm/victoria-metrics-k8s-stack 0.9.7        	1.79.0      Kubernetes monitoring on VictoriaMetrics stack....
vm/victoria-metrics-operator  0.9.0        	0.24.0      Victoria Metrics Operator
vm/victoria-metrics-single    0.8.33        	1.79.0      Victoria Metrics Single version - high-performa...
```
