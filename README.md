...
vm/victoria-metrics-agent    	0.8.33       	v1.88.1    	Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-alert    	0.5.19       	v1.88.1    	Victoria Metrics Alert - executes a list of giv...
vm/victoria-metrics-anomaly  	0.3.1        	v1.1.0     	Victoria Metrics Anomaly Detection - a service ...
vm/victoria-metrics-auth     	0.2.74       	1.88.1     	Victoria Metrics Auth - is a simple auth proxy ...
vm/victoria-metrics-cluster  	0.9.56       	1.88.1     	Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-gateway  	0.1.32       	1.88.1     	Victoria Metrics Gateway - Auth & Rate-Limittin...
vm/victoria-metrics-k8s-stack	0.14.10       	1.88.1     	Kubernetes monitoring on VictoriaMetrics stack....
vm/victoria-metrics-operator 	0.18.0       	0.30.4     	Victoria Metrics Operator
vm/victoria-metrics-single   	0.8.55       	1.88.1     	Victoria Metrics Single version - high-performa...
```
