...
vm/victoria-metrics-agent    0.6.7          v1.49.0     Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-alert    0.3.7          v1.49.0     Victoria Metrics Alert - executes a list of giv...
vm/victoria-metrics-auth     0.2.3          1.49.0      Victoria Metrics Auth - is a simple auth proxy ...
vm/victoria-metrics-cluster  0.8.4          1.49.0      Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-operator 0.1.2          0.4.0       Victoria Metrics Operator
vm/victoria-metrics-single   0.6.6          1.49.0      Victoria Metrics Single version - high-performa...
```
