...
vm/victoria-metrics-agent     0.7.35       	v1.70.0     Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-alert     0.4.15        	v1.70.0     Victoria Metrics Alert - executes a list of giv...
vm/victoria-metrics-auth      0.2.35       	1.70.0      Victoria Metrics Auth - is a simple auth proxy ...
vm/victoria-metrics-cluster   0.9.13        	1.70.0      Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-k8s-stack 0.6.1        	1.70.0      Kubernetes monitoring on VictoriaMetrics stack....
vm/victoria-metrics-operator  0.5.1        	0.21.0      Victoria Metrics Operator
vm/victoria-metrics-single    0.8.13        	1.70.0      Victoria Metrics Single version - high-performa...
```
