...
vm/victoria-metrics-agent     0.8.30       	v1.87.0     Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-alert     0.5.15        	v1.87.0     Victoria Metrics Alert - executes a list of giv...
vm/victoria-metrics-auth      0.2.71       	1.87.0      Victoria Metrics Auth - is a simple auth proxy ...
vm/victoria-metrics-cluster   0.9.53        	1.87.0      Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-gateway   0.1.29        	1.87.0      Victoria Metrics Gateway - is a simple gateway ...
vm/victoria-metrics-k8s-stack 0.14.7        	1.87.0      Kubernetes monitoring on VictoriaMetrics stack....
vm/victoria-metrics-operator  0.12.1        	0.27.1      Victoria Metrics Operator
vm/victoria-metrics-single    0.8.52        	1.87.0      Victoria Metrics Single version - high-performa...
```
