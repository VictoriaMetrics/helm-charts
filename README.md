...
vm/victoria-metrics-agent  	0.5.5        	v1.41.1    	Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-cluster	0.6.8        	1.41.1     	Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-single 	0.5.24        	1.41.1     	Victoria Metrics Single version - high-performa...
```
