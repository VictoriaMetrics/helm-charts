...
vm/victoria-metrics-agent    	0.9.7       	v1.93.2            	Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-alert    	0.7.5        	v1.93.2            	Victoria Metrics Alert - executes a list of giv...
vm/victoria-metrics-anomaly  	0.3.4        	v1.1.0             	Victoria Metrics Anomaly Detection - a service ...
vm/victoria-metrics-auth     	0.3.5       	v1.93.2            	Victoria Metrics Auth - is a simple auth proxy ...
vm/victoria-metrics-cluster  	0.10.6       	v1.93.2            	Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-gateway  	0.1.45       	v1.93.2            	Victoria Metrics Gateway - Auth & Rate-Limittin...
vm/victoria-metrics-k8s-stack	0.17.6       	v1.93.2            	Kubernetes monitoring on VictoriaMetrics stack....
vm/victoria-metrics-operator 	0.23.1       	0.34.1             	Victoria Metrics Operator
vm/victoria-metrics-single   	0.9.6       	v1.93.2            	Victoria Metrics Single version - high-performa...
```
