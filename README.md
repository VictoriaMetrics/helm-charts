...
vm/victoria-metrics-agent  	0.4.14        	v1.39.4    	Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-cluster	0.6.1        	1.39.4     	Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-single 	0.5.19        	1.39.4     	Victoria Metrics Single version - high-performa...
```
