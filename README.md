...
vm/victoria-metrics-agent    0.7.12         v1.57.1     Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-alert    0.3.26         v1.57.1     Victoria Metrics Alert - executes a list of giv...
vm/victoria-metrics-auth     0.2.18         1.57.1      Victoria Metrics Auth - is a simple auth proxy ...
vm/victoria-metrics-cluster  0.8.20         1.57.1      Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-operator 0.1.9          0.11.0       Victoria Metrics Operator
vm/victoria-metrics-single   0.6.21         1.57.1      Victoria Metrics Single version - high-performa...
```
