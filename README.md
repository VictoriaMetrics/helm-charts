...
vm/victoria-metrics-agent    0.7.10         v1.56.0     Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-alert    0.3.22         v1.56.0     Victoria Metrics Alert - executes a list of giv...
vm/victoria-metrics-auth     0.2.16         1.56.0      Victoria Metrics Auth - is a simple auth proxy ...
vm/victoria-metrics-cluster  0.8.18         1.56.0      Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-operator 0.1.5          0.7.0       Victoria Metrics Operator
vm/victoria-metrics-single   0.6.19         1.56.0      Victoria Metrics Single version - high-performa...
```
...
NAME                         CHART VERSION  APP VERSION DESCRIPTION
vm/victoria-metrics-agent    0.7.10         v1.56.0     Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-alert    0.3.24         v1.56.0     Victoria Metrics Alert - executes a list of giv...
vm/victoria-metrics-auth     0.2.16         1.56.0      Victoria Metrics Auth - is a simple auth proxy ...
vm/victoria-metrics-cluster  0.8.18         1.56.0      Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-operator 0.1.9          0.11.0       Victoria Metrics Operator
vm/victoria-metrics-single   0.6.19         1.56.0      Victoria Metrics Single version - high-performa...
```
