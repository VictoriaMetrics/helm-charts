...
vm/victoria-logs-single          	0.9.7        	v1.20.0             	Victoria Logs Single version - high-performance...
vm/victoria-metrics-agent        	0.18.2       	v1.115.0            	Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-alert        	0.17.2       	v1.115.0            	Victoria Metrics Alert - executes a list of giv...
vm/victoria-metrics-anomaly      	1.9.1        	v1.22.0-experimental	Victoria Metrics Anomaly Detection - a service ...
vm/victoria-metrics-auth         	0.12.1       	v1.115.0            	Victoria Metrics Auth - is a simple auth proxy ...
vm/victoria-metrics-cluster      	0.20.1       	v1.115.0            	Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-common       	0.0.42       	                    	Victoria Metrics Common - contains shared templ...
vm/victoria-metrics-distributed  	0.13.2       	v1.115.0            	A Helm chart for Running VMCluster on Multiple ...
vm/victoria-metrics-gateway      	0.10.1       	v1.115.0            	Victoria Metrics Gateway - Auth & Rate-Limittin...
vm/victoria-metrics-k8s-stack    	0.44.0       	v1.115.0            	Kubernetes monitoring on VictoriaMetrics stack....
...
vm/victoria-metrics-single       	0.17.1       	v1.115.0            	Victoria Metrics Single version - high-performa...
```
