...
vm/victoria-metrics-agent  	0.5.7        	v1.43.0    	Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-cluster	0.6.10        	1.43.0     	Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-single 	0.5.26        	1.43.0     	Victoria Metrics Single version - high-performa...
```
