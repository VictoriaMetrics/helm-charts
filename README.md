...
vm/victoria-metrics-agent    0.7.7          v1.55.0     Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-alert    0.3.19         v1.55.0     Victoria Metrics Alert - executes a list of giv...
vm/victoria-metrics-auth     0.2.14         1.55.0      Victoria Metrics Auth - is a simple auth proxy ...
vm/victoria-metrics-cluster  0.8.16         1.55.0      Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-operator 0.1.5          0.7.0       Victoria Metrics Operator
vm/victoria-metrics-single   0.6.17         1.55.0      Victoria Metrics Single version - high-performa...
```
