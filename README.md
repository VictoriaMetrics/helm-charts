...
vm/victoria-metrics-agent    0.6.4          v1.46.0     Victoria Metrics Agent - collects metrics from ...
...
vm/victoria-metrics-cluster  0.8.1          1.46.0      Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-operator 0.1.1          0.2.1       Victoria Metrics Operator
vm/victoria-metrics-single   0.6.3          1.46.0      Victoria Metrics Single version - high-performa...
```
