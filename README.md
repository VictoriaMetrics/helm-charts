...
vm/victoria-metrics-agent    	0.9.14       	v1.96.0            	Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-alert    	0.8.5        	v1.96.0            	Victoria Metrics Alert - executes a list of giv...
vm/victoria-metrics-anomaly  	0.5.0        	v1.6.0             	Victoria Metrics Anomaly Detection - a service ...
vm/victoria-metrics-auth     	0.4.4       	v1.96.0            	Victoria Metrics Auth - is a simple auth proxy ...
vm/victoria-metrics-cluster  	0.11.8       	v1.96.0            	Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-gateway  	0.1.53       	v1.96.0            	Victoria Metrics Gateway - Auth & Rate-Limittin...
vm/victoria-metrics-k8s-stack	0.18.10       	v1.96.0            	Kubernetes monitoring on VictoriaMetrics stack....
vm/victoria-metrics-operator 	0.27.9       	0.39.4             	Victoria Metrics Operator
vm/victoria-metrics-single   	0.9.13       	v1.96.0            	Victoria Metrics Single version - high-performa...
```
