...
vm/victoria-metrics-agent    0.7.1          v1.52.0     Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-alert    0.3.12         v1.52.0     Victoria Metrics Alert - executes a list of giv...
vm/victoria-metrics-auth     0.2.8          1.52.0      Victoria Metrics Auth - is a simple auth proxy ...
vm/victoria-metrics-cluster  0.8.10         1.52.0      Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-operator 0.1.5          0.7.0       Victoria Metrics Operator
vm/victoria-metrics-single   0.6.11         1.52.0      Victoria Metrics Single version - high-performa...
```
