...
vm/victoria-metrics-agent  	0.4.13        	v1.39.3    	Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-cluster	0.5.23        	1.39.3     	Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-single 	0.5.18        	1.39.3     	Victoria Metrics Single version - high-performa...
```
