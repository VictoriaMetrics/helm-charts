...
vm/victoria-metrics-agent  	0.4.15        	v1.40.0    	Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-cluster	0.6.2        	1.40.0     	Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-single 	0.5.20        	1.40.0     	Victoria Metrics Single version - high-performa...
```
