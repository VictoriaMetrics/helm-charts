...
vm/victoria-metrics-agent  	0.4.11        	v1.39.1    	Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-cluster	0.5.21        	1.39.1     	Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-single 	0.5.16        	1.39.1     	Victoria Metrics Single version - high-performa...
```
