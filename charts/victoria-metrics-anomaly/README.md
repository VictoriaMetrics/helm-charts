...
| config.models.prophet_model.args | object | `{}` | Inner model args (key-value pairs) accepted by -- Arguments specific to [model](https://docs.victoriametrics.com/anomaly-detection/components/models/) |
