...
| config.model.args | object | `{}` | Arguments specific to model https://docs.victoriametrics.com/anomaly-detection/components/models/ |
| config.model.class | string | `"model.prophet.ProphetModel"` | Supported models by vmanomaly helm chart. vmanomaly supports more models |
...
| config.scheduler.class | string | `"scheduler.periodic.PeriodicScheduler"` | https://docs.victoriametrics.com/anomaly-detection/components/scheduler/ |
