# Victoria Metrics Helm Chart for Single Version
 ...
 ![Version: 0.8.30](https://img.shields.io/badge/Version-0.8.30-informational?style=flat-square)
...
| server.image.tag | string | `"v1.77.2"` | Image tag |
...
| server.vmbackupmanager.image.tag | string | `"v1.77.2-enterprise"` | vmbackupmanager image tag |
