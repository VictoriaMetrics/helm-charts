# Victoria Metrics Helm Chart for Single Version
 ...
 ![Version: 0.8.57](https://img.shields.io/badge/Version-0.8.57-informational?style=flat-square)
...
| server.image.tag | string | `"v1.89.1"` | Image tag |
...
| server.vmbackupmanager.image.tag | string | `"v1.89.1-enterprise"` | vmbackupmanager image tag |
