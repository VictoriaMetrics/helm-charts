...
| server.retentionPeriod | string | `"1m"` | Data retention period starting from "1d" (one day) up to "100y" (100 years). See these [docs](https://prometheus.io/docs/prometheus/latest/querying/basics/#time-durations) for the supported duration formats. |
