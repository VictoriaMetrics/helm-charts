# Victoria Metrics Helm Chart for Single Version
 ...
 ![Version: 0.8.50](https://img.shields.io/badge/Version-0.8.50-informational?style=flat-square)
...
| server.image.tag | string | `"v1.86.2"` | Image tag |
...
| server.vmbackupmanager.image.tag | string | `"v1.86.2-enterprise"` | vmbackupmanager image tag |
