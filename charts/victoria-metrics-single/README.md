...
| server.image.tag | string | `"v1.99.0"` | Image tag |
...
| server.retentionPeriod | string | `"1d"` | Data retention period starting from "1d" (one day) up to "100y" (100 years). See these [docs](https://prometheus.io/docs/prometheus/latest/querying/basics/#time-durations) for the supported duration formats. |
...
| server.vmbackupmanager.image.tag | string | `"v1.99.0-enterprise"` | vmbackupmanager image tag |
...
| server.vmbackupmanager.restore.onStart.enabled | bool | `false` |  |
