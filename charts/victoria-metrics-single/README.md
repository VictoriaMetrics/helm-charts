...
| server.image.tag | string | `"v1.61.0"` | Image tag |
...
| server.scrape.enabled | bool | `true` | If true scrapes targets, creates config map or use specified one with scrape targets |
