# Victoria Metrics Helm Chart for Single Version
 ...
 ![Version: 0.8.56](https://img.shields.io/badge/Version-0.8.56-informational?style=flat-square)
...
| server.image.tag | string | `"v1.89.0"` | Image tag |
...
| server.vmbackupmanager.image.tag | string | `"v1.89.0-enterprise"` | vmbackupmanager image tag |
