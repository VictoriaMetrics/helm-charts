# Victoria Metrics Helm Chart for Single Version
 ...
 ![Version: 0.8.61](https://img.shields.io/badge/Version-0.8.61-informational?style=flat-square)
...
| server.image.tag | string | `"v1.91.1"` | Image tag |
...
| server.vmbackupmanager.image.tag | string | `"v1.91.1-enterprise"` | vmbackupmanager image tag |
