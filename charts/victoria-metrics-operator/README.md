...
| image.tag | string | `"v0.44.0"` | Image tag |
...
| rbac.createAggregateClusterRoles | bool | `true` | create agregate clusterroles for CRD readonly and admin permissions |
| rbac.labels.admin."rbac.authorization.k8s.io/aggregate-to-admin" | string | `"true"` |  |
| rbac.labels.view."rbac.authorization.k8s.io/aggregate-to-view" | string | `"true"` |  |
