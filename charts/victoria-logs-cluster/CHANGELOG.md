...
- Fix vlstorage.persistentVolume.existingClaim functionality for StatefulSet mode. When existingClaim is set, the chart now properly uses volumeClaimTemplates instead of trying to reference a single PVC name for all replicas.
