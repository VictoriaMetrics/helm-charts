...
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)  ![Version: 0.6.6](https://img.shields.io/badge/Version-0.6.6-informational?style=flat-square)
...
| vmcluster.spec.vminsert.image.tag | string | `"v1.72.0-cluster"` |  |
...
| vmcluster.spec.vmselect.image.tag | string | `"v1.72.0-cluster"` |  |
...
| vmcluster.spec.vmstorage.image.tag | string | `"v1.72.0-cluster"` |  |
