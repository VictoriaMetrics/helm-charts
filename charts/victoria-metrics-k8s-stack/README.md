...
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square)  ![Version: 0.18.6](https://img.shields.io/badge/Version-0.18.6-informational?style=flat-square)
...
| vmagent.spec.image.tag | string | `"v1.94.0"` |  |
...
| vmalert.spec.image.tag | string | `"v1.94.0"` |  |
...
| vmcluster.spec.vminsert.image.tag | string | `"v1.94.0-cluster"` |  |
...
| vmcluster.spec.vmselect.image.tag | string | `"v1.94.0-cluster"` |  |
...
| vmcluster.spec.vmstorage.image.tag | string | `"v1.94.0-cluster"` |  |
