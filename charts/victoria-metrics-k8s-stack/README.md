...
| vmagent.spec.image.tag | string | `"v1.88.0"` |  |
...
| vmalert.spec.image.tag | string | `"v1.88.0"` |  |
...
| vmcluster.spec.vminsert.image.tag | string | `"v1.88.0-cluster"` |  |
...
| vmcluster.spec.vmselect.image.tag | string | `"v1.88.0-cluster"` |  |
...
| vmcluster.spec.vmstorage.image.tag | string | `"v1.88.0-cluster"` |  |
