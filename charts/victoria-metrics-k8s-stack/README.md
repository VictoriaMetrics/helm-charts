...
| vmagent.spec.image.tag | string | `"v1.69.0"` |  |
...
| vmalert.spec.image.tag | string | `"v1.69.0"` |  |
...
| vmcluster.spec.vminsert.image.tag | string | `"v1.69.0-cluster"` |  |
...
| vmcluster.spec.vmselect.image.tag | string | `"v1.69.0-cluster"` |  |
...
| vmcluster.spec.vmstorage.image.tag | string | `"v1.69.0-cluster"` |  |
...
| vmsingle | object | `{"enabled":true,"ingress":{"annotations":{},"enabled":false,"extraPaths":[],"hosts":["vmsingle.domain.com"],"labels":{},"path":"/","pathType":"Prefix","tls":[]},"spec":{"image":{"tag":"v1.69.0"},"replicaCount":1,"retentionPeriod":"14","storage":{"accessModes":["ReadWriteOnce"],"resources":{"requests":{"storage":"20Gi"}}}}}` | Configures vmsingle params |
