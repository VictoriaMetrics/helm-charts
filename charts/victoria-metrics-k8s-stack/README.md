...
| vmagent.spec.image.tag | string | `"v1.64.0"` |  |
...
| vmalert.spec.image.tag | string | `"v1.64.0"` |  |
...
| vmcluster.spec.vminsert.image.tag | string | `"v1.64.0-cluster"` |  |
...
| vmcluster.spec.vmselect.image.tag | string | `"v1.64.0-cluster"` |  |
...
| vmcluster.spec.vmstorage.image.tag | string | `"v1.64.0-cluster"` |  |
...
| vmsingle.spec.image.tag | string | `"v1.64.0"` |  |
