...
| vmagent.spec.image.tag | string | `"v1.64.1"` |  |
...
| vmalert.spec.image.tag | string | `"v1.64.1"` |  |
...
| vmcluster.spec.vminsert.image.tag | string | `"v1.64.1-cluster"` |  |
...
| vmcluster.spec.vmselect.image.tag | string | `"v1.64.1-cluster"` |  |
...
| vmcluster.spec.vmstorage.image.tag | string | `"v1.64.1-cluster"` |  |
...
| vmsingle.spec.image.tag | string | `"v1.64.1"` |  |
