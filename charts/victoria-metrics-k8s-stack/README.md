...
| vmagent.spec.image.tag | string | `"v1.85.2"` |  |
...
| vmalert.spec.image.tag | string | `"v1.85.2"` |  |
...
| vmcluster.spec.vminsert.image.tag | string | `"v1.85.2-cluster"` |  |
...
| vmcluster.spec.vmselect.image.tag | string | `"v1.85.2-cluster"` |  |
...
| vmcluster.spec.vmstorage.image.tag | string | `"v1.85.2-cluster"` |  |
...
| vmsingle | object | `{"annotations":{},"enabled":true,"ingress":{"annotations":{},"enabled":false,"extraPaths":[],"hosts":["vmsingle.domain.com"],"labels":{},"path":"/","pathType":"Prefix","tls":[]},"spec":{"extraArgs":{},"image":{"tag":"v1.85.2"},"replicaCount":1,"retentionPeriod":"14","storage":{"accessModes":["ReadWriteOnce"],"resources":{"requests":{"storage":"20Gi"}}}}}` | Configures vmsingle params |
