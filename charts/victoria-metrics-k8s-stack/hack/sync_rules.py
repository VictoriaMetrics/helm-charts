...
condition_map = {
    ...
    'k8s.rules.container_cpu_usage_seconds_total': '.Values.k8sContainerCpuUsageSecondsTotal.enabled .Values.defaultRules.rules.k8sContainerCpuUsageSecondsTotal',
    'k8s.rules.container_memory_cache': '.Values.k8sContainerMemoryCache.enabled .Values.defaultRules.rules.k8sContainerMemoryCache',
    'k8s.rules.container_memory_rss': '.Values.k8sContainerMemoryRss.enabled .Values.defaultRules.rules.k8sContainerMemoryRss',
    'k8s.rules.container_memory_swap': '.Values.k8sContainerMemorySwap.enabled .Values.defaultRules.rules.k8sContainerMemorySwap',
    'k8s.rules.container_memory_workingSetBytes': '.Values.k8sContainerMemoryWorkingSetBytes.enabled .Values.defaultRules.rules.k8sContainerMemoryWorkingSetBytes',
    'k8s.rules.container_resource': '.Values.k8sContainerResource.enabled .Values.defaultRules.rules.k8sContainerResource',
    'k8s.rules.pod_owner': '.Values.k8sPodOwner.enabled .Values.defaultRules.rules.k8sPodOwner',
