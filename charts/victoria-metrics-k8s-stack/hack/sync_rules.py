...
condition_map = {
    ...
    'k8s.rules.container_cpu_usage_seconds_total': '.Values.k8s.enabled .Values.defaultRules.rules.container_cpu_usage_seconds_total',
    'k8s.rules.container_memory_cache': '.Values.k8s.enabled .Values.defaultRules.rules.container_memory_cache',
    'k8s.rules.container_memory_rss': '.Values.k8s.enabled .Values.defaultRules.rules.container_memory_rss',
    'k8s.rules.container_memory_swap': '.Values.k8s.enabled .Values.defaultRules.rules.container_memory_swap',
    'k8s.rules.container_memory_working_set_bytes': '.Values.k8s.enabled .Values.defaultRules.rules.container_memory_working_set_bytes',
    'k8s.rules.container_resource': '.Values.k8s.enabled .Values.defaultRules.rules.container_resource',
