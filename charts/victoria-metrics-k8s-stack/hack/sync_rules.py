...
condition_map = {
    ...
    'k8s.rules.container_cpu_usage_seconds_total': '.Values.defaultRules.rules.containerCpuUsageSecondsTotal',
    'k8s.rules.container_memory_cache': '.Values.defaultRules.rules.containerMemoryCache',
    'k8s.rules.container_memory_rss': '.Values.defaultRules.rules.containerMemoryRss',
    'k8s.rules.container_memory_swap': '.Values.defaultRules.rules.containerMemorySwap',
    'k8s.rules.container_memory_workingSetBytes': '.Values.defaultRules.rules.containerMemoryWorkingSetBytes',
    'k8s.rules.container_resource': '.Values.defaultRules.rules.containerResource',
    'k8s.rules.pod_owner': '.Values.defaultRules.rules.podOwner',
