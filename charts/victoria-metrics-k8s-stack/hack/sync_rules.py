...
condition_map = {
    ...
    'k8s.rules.container_cpu_usage_seconds_total': '.Values.container_cpu_usage_seconds_total.enabled .Values.defaultRules.rules.container_cpu_usage_seconds_total',
    'k8s.rules.container_memory_cache': '.Values.container_memory_cache.enabled .Values.defaultRules.rules.container_memory_cache',
    'k8s.rules.container_memory_rss': '.Values.container_memory_rss.enabled .Values.defaultRules.rules.container_memory_rss',
    'k8s.rules.container_memory_swap': '.Values.container_memory_swap.enabled .Values.defaultRules.rules.container_memory_swap',
    'k8s.rules.container_memory_working_set_bytes': '.Values.container_memory_working_set_bytes.enabled .Values.defaultRules.rules.container_memory_working_set_bytes',
    'k8s.rules.container_resource': '.Values.container_resource.enabled .Values.defaultRules.rules.container_resource',
    'k8s.rules.pod_owner': '.Values.k8s.enabled .Values.defaultRules.rules.pod_owner',
