...
condition_map = {
    ...
    'k8s.rules.container_cpu_usage_seconds_total': '.Values.ContainerCpuUsageSecondsTotal.enabled .Values.defaultRules.rules.ContainerCpuUsageSecondsTotal',
    'k8s.rules.container_memory_cache': '.Values.containerMemoryCache.enabled .Values.defaultRules.rules.containerMemoryCache',
    'k8s.rules.container_memory_rss': '.Values.containerMemoryRss.enabled .Values.defaultRules.rules.containerMemoryRss',
    'k8s.rules.container_memory_swap': '.Values.containerMemorySwap.enabled .Values.defaultRules.rules.containerMemorySwap',
    'k8s.rules.container_memory_workingSetBytes': '.Values.containerMemoryWorkingSetBytes.enabled .Values.defaultRules.rules.containerMemoryWorkingSetBytes',
    'k8s.rules.container_resource': '.Values.containerResource.enabled .Values.defaultRules.rules.containerResource',
    'k8s.rules.pod_owner': '.Values.podOwner.enabled .Values.defaultRules.rules.podOwner',
