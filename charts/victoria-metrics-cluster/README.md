...
| vminsert.image.tag | string | `"v1.85.2-cluster"` | Image tag |
...
| vmselect.image.tag | string | `"v1.85.2-cluster"` | Image tag |
...
| vmstorage.image.tag | string | `"v1.85.2-cluster"` | Image tag |
...
| vmstorage.vmbackupmanager.image.tag | string | `"v1.85.2-enterprise"` | vmbackupmanager image tag |
