...
| vminsert.envFrom | list | `[]` | Additional environment variables by referencing secrets or configmaps |
...
| vmselect.envFrom | list | `[]` | Additional environment variables by referencing secrets or configmaps |
...
| vmstorage.envFrom | list | `[]` | Additional environment variables by referencing secrets or configmaps |
