...
| vminsert.image.tag | string | `"v1.51.0-cluster"` | Image tag |
...
| vmselect.image.tag | string | `"v1.51.0-cluster"` | Image tag |
...
| vmstorage.image.tag | string | `"v1.51.0-cluster"` | Image tag |
