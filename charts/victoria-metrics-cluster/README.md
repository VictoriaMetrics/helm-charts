...
| vminsert.image.tag | string | `"v1.88.1-cluster"` | Image tag |
...
| vmselect.image.tag | string | `"v1.88.1-cluster"` | Image tag |
...
| vmstorage.image.tag | string | `"v1.88.1-cluster"` | Image tag |
...
| vmstorage.vmbackupmanager.image.tag | string | `"v1.88.1-enterprise"` | vmbackupmanager image tag |
