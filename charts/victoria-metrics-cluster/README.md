...
| vminsert.image.tag | string | `"v1.50.1-cluster"` | Image tag |
...
| vmselect.image.tag | string | `"v1.50.1-cluster"` | Image tag |
...
| vmstorage.image.tag | string | `"v1.50.1-cluster"` | Image tag |
