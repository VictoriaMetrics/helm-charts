# Victoria Metrics Helm Chart for Cluster Version
 ...
 ![Version: 0.9.69](https://img.shields.io/badge/Version-0.9.69-informational?style=flat-square)
...
| vminsert.image.tag | string | `"v1.91.1-cluster"` | Image tag |
...
| vmselect.image.tag | string | `"v1.91.1-cluster"` | Image tag |
...
| vmstorage.image.tag | string | `"v1.91.1-cluster"` | Image tag |
...
| vmstorage.vmbackupmanager.image.tag | string | `"v1.91.1-enterprise"` | vmbackupmanager image tag |
