# Victoria Metrics Helm Chart for Cluster Version
 ...
 ![Version: 0.9.63](https://img.shields.io/badge/Version-0.9.63-informational?style=flat-square)
...
| vminsert.image.tag | string | `"v1.91.0-cluster"` | Image tag |
...
| vmselect.image.tag | string | `"v1.91.0-cluster"` | Image tag |
...
| vmstorage.image.tag | string | `"v1.91.0-cluster"` | Image tag |
...
| vmstorage.vmbackupmanager.image.tag | string | `"v1.91.0-enterprise"` | vmbackupmanager image tag |
