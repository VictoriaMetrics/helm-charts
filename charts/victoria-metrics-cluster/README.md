...
| vminsert.image.tag | string | `"v1.53.1-cluster"` | Image tag |
...
| vmselect.image.tag | string | `"v1.53.1-cluster"` | Image tag |
...
| vmstorage.image.tag | string | `"v1.53.1-cluster"` | Image tag |
