...
| vminsert.image.tag | string | `"v1.93.5-cluster"` | Image tag |
...
| vmselect.image.tag | string | `"v1.93.5-cluster"` | Image tag |
...
| vmstorage.image.tag | string | `"v1.93.5-cluster"` | Image tag |
...
| vmstorage.vmbackupmanager.image.tag | string | `"v1.93.5-enterprise"` | vmbackupmanager image tag |
